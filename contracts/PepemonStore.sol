...
contract PepemonStore is Ownable {
    ...
    function redeem(uint256 card) public {
        ...
        PepedexToken.safeTransferFrom(msg.sender, address(0), cardCosts[card].mul(9).div(10));
        PepedexToken.safeTransferFrom(msg.sender, fundAddress, cardCosts[card].mul(1).div(10));
